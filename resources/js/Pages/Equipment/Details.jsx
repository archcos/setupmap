      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
        ...
        <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 mb-4 sm:mb-6 border border-gray-200">
          ...
          <div className="flex flex-wrap gap-2">
            <button onClick={() => handleQuickRange(0)} className="px-3 py-1.5 rounded-lg bg-blue-100 text-blue-700 font-medium hover:bg-blue-200 transition-colors text-sm">Today</button>
            <button onClick={() => handleQuickRange(7)} className="px-3 py-1.5 rounded-lg bg-blue-100 text-blue-700 font-medium hover:bg-blue-200 transition-colors text-sm">Last 7 Days</button>
            <button onClick={() => handleQuickRange(30)} className="px-3 py-1.5 rounded-lg bg-blue-100 text-blue-700 font-medium hover:bg-blue-200 transition-colors text-sm">Last 30 Days</button>
            <button onClick={() => handleQuickRange(90)} className="px-3 py-1.5 rounded-lg bg-blue-100 text-blue-700 font-medium hover:bg-blue-200 transition-colors text-sm">Last 90 Days</button>
            <button onClick={() => setShowCustomDatePicker(!showCustomDatePicker)} className="px-3 py-1.5 rounded-lg bg-gray-100 text-gray-700 font-medium hover:bg-gray-200 transition-colors text-sm">Custom</button>
            <button onClick={() => {
              const now = new Date();
              const start = getStartOfDay(now);
              const end = getEndOfDay(now);
              setDateRangeLabel(formatDateRangeLabel(now, now, true));
              fetchEquipmentData(start, end);
            }} className="px-3 py-1.5 rounded-lg bg-gray-100 text-gray-700 hover:bg-gray-200 transition-colors text-sm ml-auto">
          ...
          {showCustomDatePicker && (
            <div className="border-t border-gray-200 pt-4 mt-4">
              <div className="flex flex-wrap gap-4 items-end">
                ...
                <button onClick={handleCustomDateRange} disabled={loading} className="px-4 py-2 rounded-lg bg-blue-600 text-white font-medium hover:bg-blue-700 transition-colors disabled:opacity-50 text-sm">
        ...
        <div className="flex gap-1 sm:gap-2 mb-6 border-b border-gray-200 overflow-x-auto">
          {['overview', 'utilization', 'power'].map((tab) => (
            <button key={tab} onClick={() => setActiveTab(tab)} className={`px-4 sm:px-6 py-2.5 sm:py-3 font-medium transition-colors border-b-2 whitespace-nowrap text-sm ${
